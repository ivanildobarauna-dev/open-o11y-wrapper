...
class TestMetricsProcessorService:
    ...
    def test_metric_increment(self):
        ...
        mock_exporter.metric_increment.assert_called_once_with(name=name, tags=tags, value=value)
    ...
    def test_metric_increment_default_value(self):
        ...
        mock_exporter.metric_increment.assert_called_once_with(name=name, tags=tags, value=1.0)
    ...
    def test_record_gauge(self):
        ...
        # Verify the exporter was called
        mock_exporter.record_gauge.assert_called_once_with(name=name, tags=tags, value=value)
    ...
    def test_record_histogram(self):
        ...
        # Verify the exporter was called
        mock_exporter.record_histogram.assert_called_once_with(name=name, tags=tags, value=value)